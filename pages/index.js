...
const DailyTimeBox = () => {
  ...
  return (
    <>
      <Head>
        <title>Daily Time Box</title>
        <meta name="description" content="Daily time management and planning tool" />
            ...
            <div className="overflow-hidden">
              ...
              <div className="max-h-80 overflow-y-auto">
                {timeSlots.map((time, index) => (
                  <div key={`${time}-${index}`} className={`grid border-b ${themeClasses.border} last:border-b-0 hover:bg-purple-50 dark:hover:bg-gray-700 transition-all`} style={{gridTemplateColumns: '60px 1fr 1fr'}}>
